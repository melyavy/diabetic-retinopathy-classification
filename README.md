...
The model in this study was developed using the Diagnosis of Diabetic Retinopathy dataset obtained from [Kaggle📂](https://www.kaggle.com/datasets/pkdarabi/diagnosis-of-diabetic-retinopathy)
